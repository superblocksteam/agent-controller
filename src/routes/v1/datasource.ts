...
router.post('/:datasourceId/metadata', (req: Request, res: Response, next: NextFunction) => {
  (async () => {
...
router.get('/:datasourceId/metadata', (req: Request, res: Response, next: NextFunction) => {
  (async () => {
    const datasourceId = req.params.datasourceId;
    const environment = req.query.environment as string;
    const actionId = req.query.actionId;
...
router.delete('/:datasourceId', (req: Request, res: Response, next: NextFunction) => {
  (async () => {
    const datasourceId = req.params.datasourceId;
    const environment = req.query.environment as string;
    try {
